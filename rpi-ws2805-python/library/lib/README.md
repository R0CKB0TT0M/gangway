...
Language-specific bindings for rpi_ws2805 are available in:

* Python - https://github.com/rpi-ws2805/rpi-ws2805-python
* Rust - https://github.com/rpi-ws2805/rpi-ws2805-rust
* Powershell - https://github.com/rpi-ws2805/rpi-ws2805-powershell
* Java - https://github.com/rpi-ws2805/rpi-ws2805-java
* CSharp - https://github.com/rpi-ws2805/rpi-ws2805-csharp
* Go - https://github.com/rpi-ws2805/rpi-ws2805-go
* Swift - https://github.com/kbongort/rpi-ws2805-swift
...
For example, **using DMA channel 5 [will cause](https://github.com/jgarff/rpi_ws2805/issues/224) filesystem corruption** on the Raspberry Pi 3 Model B.
...
On an RPi 4 you must set a fixed frequency to avoid the idle CPU scaling changing the SPI frequency and breaking the ws2805 timings:
