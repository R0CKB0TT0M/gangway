// SWIG interface file to define rpi_ws2805 library python wrapper.
// Author: Tony DiCola (tony@tonydicola.com), Jeremy Garff (jer@jers.net)

// Define module name rpi_ws2805.  This will actually be imported under
// the name _rpi_ws2805 following the SWIG & Python conventions.
%module rpi_ws2805
...
%inline %{
    ...
    uint64_t ws2811_led_get(ws2811_channel_t *channel, int lednum)
    {
        ...
        {
            return 0; // -1 would overflow unsigned
        }
