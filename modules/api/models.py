"""
This file is auto-generated by generate_models.py. DO NOT EDIT.
It contains the Pydantic models for validating animation configurations.
"""
...
AnyAnimationModel = Literal["AnyAnimationModel"]  # Placeholder
...
class AlternateParams(BaseModel):
    ...
    animations: List["AnyAnimationModel"] = Field(default_factory=list)
    length: float = 10
...
class StroboParams(BaseModel):
    ...
    colors: List[RGBCCTModel] = Field(default=[1099511627775, 0, 255, 0, 16711680])
    frequency: int = 100
...
class DotParams(BaseModel):
    ...
    primary: Optional[Union["AnyAnimationModel", RGBCCTModel]] = None
    secondary: Optional[Union["AnyAnimationModel", RGBCCTModel]] = None
    radius: float = 150
...
class ExponentialParams(BaseModel):
    ...
    primary: Union["AnyAnimationModel", RGBCCTModel] = Field(
        default=RGBCCTModel(r=255, g=0, b=0, cw=0, ww=0)
    )
    secondary: Union["AnyAnimationModel", RGBCCTModel] = Field(
